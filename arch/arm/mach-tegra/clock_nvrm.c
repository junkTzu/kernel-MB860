 ...
 */
//Legacy tegra clock duplicates
struct clk_duplicate legacy_tegra_clk_duplicates[] = {
...
void __init tegra2_init_clocks(void)
{
	...
	for (i = 0; i < ARRAY_SIZE(legacy_tegra_clk_duplicates); i++) {
		cd = &legacy_tegra_clk_duplicates[i];
